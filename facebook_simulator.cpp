...
{
	std::cout << "\nSOCIAL MEDIA MENU\n";
	std::cout << "1. View Friend List\n";
	std::cout << "2. View Liked Pages\n";
	std::cout << "3. View Home Page\n";
	std::cout << "4. View Timeline\n";
	std::cout << "5. View Liked Lists\n";
	std::cout << "6. Like a Post\n";
	std::cout << "7. View Liked List\n";
	std::cout << "8. View a Specific Post\n";
	std::cout << "9. View Posts\n";
	std::cout << "10. See a Memory\n";
	std::cout << "11. Share a Memory\n";
	std::cout << "12. View Time Line.\n";
	std::cout << "13. View page\n";
	std::cout << " exit(enter-1)\n";
...
int main()
{
	...
	cout << "\n\n\n\t\t\tRUNNING COMMANDS\n\n";
	fb.SetCurrentDate(15, 11, 2023);
	cout << "System Date: \t" << Date::CurrentDate.GetDate() << endl;
	char curruser[2];
	cout << "enter user:";
	cin >> curruser;
	User *currentUser = fb.SetCurrentUser(curruser);
	int input;
	if (currentUser != 0)
	{
		...
		while (input != -1)
		{
			...
			if (input == 6)
			{
				fb.LikePost("post5", currentUser); // To like a post.
				cout << "LIKED LIST======================";
				/// fun.
			}
			if (input == 7)
